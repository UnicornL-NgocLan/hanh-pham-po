...
export const useZustand = create((set) => ({
    ...
    setBackupPoState: (value) => set({ backup_pos: value }),
    setPoLineState: (value) => set({ po_lines: value }),
    setContractState: (value) => set({ contracts: value }),
    setBrandState: (value) => set({ brands: value }),
    setBundleState: (value) => set({ bundles: value }),
    setPackingState: (value) => set({ packings: value }),
}))
